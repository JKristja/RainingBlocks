...
import main.model.TPiece;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import java.util.ArrayList;

import static main.model.TPiece.T_SHAPE;
import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * unit tests for TPiece class
 */
public class TPieceTest extends PuzzlePieceTest {
    ...
    @BeforeEach
    public void setUp() {
        puzzlePiece = new TPiece(PIECE_X0, PIECE_Y0);
    }
    ...
    public void testColor() {
        assertEquals(T_PIECE_COLOR, puzzlePiece.getColor());
    }
