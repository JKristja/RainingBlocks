...
import main.model.LPiece;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import java.util.ArrayList;

import static main.model.LPiece.L_SHAPE;
import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * unit tests for LPiece class
 */
public class LPieceTest extends PuzzlePieceTest {
    ...
    @BeforeEach
    public void setUp() {
        puzzlePiece = new LPiece(PIECE_X0, PIECE_Y0);
    }
    ...
    public void testColor() {
        assertEquals(L_PIECE_COLOR, puzzlePiece.getColor());
    }
