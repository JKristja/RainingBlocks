...
import main.model.ZigPiece;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import java.util.ArrayList;

import static main.model.ZigPiece.ZIG_SHAPE;
import static org.junit.jupiter.api.Assertions.assertEquals;

/**
 * unit tests for ZigPiece class
 */
public class ZigPieceTest extends PuzzlePieceTest {
    ...
    @BeforeEach
    public void setUp() {
        puzzlePiece = new ZigPiece(PIECE_X0, PIECE_Y0);
    }
    ...
    public void testColor() {
        assertEquals(ZIG_PIECE_COLOR, puzzlePiece.getColor());
    }
